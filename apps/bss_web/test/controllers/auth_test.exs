defmodule BssWeb.AuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> bypass_through(BssWeb.Router, :browser)
      |> get("/")
  ...
  test "authenticate_user continues when the current_user exists", %{conn: conn} do
    conn =
      conn
      |> assign(:current_user, %BssWeb.User{})
  ...
  # TODO create "negative-path" tests for above two tests
